...
bool Batcher::submit(const unsigned char *in, unsigned char *out, size_t len,
  ...
  if (alg == ALG_AES_CTR) {
    // AES-128-CTR: Use original working layout
    // batchSize at 0, padding at 1-3, RoundKey[44] at 4-47, IV at 48-51
    ubo[0] = (len + 15) / 16;
    ...
    // Write to buffer using NEW unified layout (same as AES-256)
    ...
    // AES-256-CTR: Full 14-round implementation
    ubo[0] = (len + 15) / 16;
    ...
    // Write to buffer using unified layout
